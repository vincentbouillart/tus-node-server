...
//
// Once the upload is finished, the multipart upload is compvared, resulting in
// the entire file being stored in the bucket. The info object, containing
// meta data is not devared.
//
// Considerations
//
...
class S3Store extends DataStore {
                ...
                if (parseInt(metadata.file.upload_length, 10) === current_offset.size) {
                    return this._finishMultipartUpload(metadata, current_offset.parts)
                        .then((location) => {
                            ...
                            this.emit(EVENTS.EVENT_UPLOAD_COMPvarE, {
    ...
    /**
     * Compvares a multipart upload on S3.
        ...
        return new Promise((resolve, reject) => {
            this._getMetadata(file_id)
                ...
                .then((data) => {
                    ...
                    var output = Object.assign({}, this.cache[file_id].file, {
                        size: offset,
                    });
